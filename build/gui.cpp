...
#line 129 "src/gui.cpp2"
  [[nodiscard]] auto GUI::button(cpp2::in<std::string_view> text, cpp2::in<cpp2::i32> width, cpp2::in<cpp2::i32> height, Color color) & -> bool{
    ...
    DrawRectangleRounded(rect, roundness, segments, std::move(color));
    DrawRectangleRoundedLines(rect, std::move(roundness), std::move(segments), 2.0f, std::move(border_color));
